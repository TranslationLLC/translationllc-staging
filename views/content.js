module.exports = {
  ...
  articleOnePublication: 'Sports Illustrated',
  articleOneLink: 'https://www.si.com/nba/2017/11/08/chris-paul-state-farm-cliff-paul-commercial-watch-rockets',
  articleOneHeader: 'Chris Paul Says Goodbye to Cliff Paul',
  articleOneByline: 'By: Rohan Nadkarni',
  
  articleTwoPublication: 'Adweek',
  articleTwoLink: 'http://www.adweek.com/creativity/nba-digs-deeper-into-personal-stories-on-and-off-the-court-in-ads-for-the-new-season/',
  articleTwoHeader: 'NBA Digs Deeper Into Personal Stories, On and Off the Court, in Ads for the New Season',
  articleTwoByline: 'By: David Gianatasio',
  
  articleThreePublication: 'Shoot',
  articleThreeLink: 'https://www.shootonline.com/node/73560',
  articleThreeHeader: 'Translation Hires John Fulbrook as Group Creative Director, Design',
  articleThreeByline: 'By: Robert Goldrich',

  articleFourPublication: 'New York Times',
  articleFourLink: 'https://mobile.nytimes.com/2017/09/10/fashion/dapper-dan-gucci-partnership.html?referer=',
  articleFourHeader: 'Why Steve Stoute Celebrates the Dapper Dan and Gucci Collaboration',
  articleFourByline :'By: Matthew Schneier',
