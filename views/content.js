module.exports = {
  ...
  workVideoThreeUrl: 'http://www.translationllc.com/assets/films/DSW.mp4',
  workVideoThreeHeader: 'MOVING FORWARD ONE WOMAN AT A TIME',
  workVideoThreeContent: 'Teaming up with DSW, we celebrated every woman\'s unique style to the beat of Hailee Steinfeld\'s powerful feminist anthem.',

  workVideoFourUrl: 'http://www.translationllc.com/assets/films/NBAB0162H_2017_NBA_website.mp4',
  workVideoFourHeader: 'GOLDEN STATE\'S HOME COURT ADVANTAGE',
  workVideoFourContent: 'There are unseen forces all over the NBA that motivate players and teams to play as hard as they do. At Oracle Arena, Megan Cooper lays out the shirts before big games and helps create Oakland electric atmosphere. She is why there is such a thing as home court advantage for Golden State.',
  ...
  articleOnePublication: 'The Wall Street Journal',
  articleOneLink: 'https://www.wsj.com/articles/silicon-valley-firms-back-new-music-venture-helmed-by-steve-stoute-1510747381',
  articleOneHeader: 'Silicon Valley Firms Back New Music Venture Helmed by Steve Stoute',
  articleOneByline :'By: Alexandra Bruell',
  
  articleTwoPublication: 'Sports Illustrated',
  articleTwoLink: 'https://www.si.com/nba/2017/11/08/chris-paul-state-farm-cliff-paul-commercial-watch-rockets',
  articleTwoHeader: 'Chris Paul Says Goodbye to Cliff Paul',
  articleTwoByline: 'By: Rohan Nadkarni',
  
  articleThreePublication: 'Adweek',
  articleThreeLink: 'http://www.adweek.com/creativity/nba-digs-deeper-into-personal-stories-on-and-off-the-court-in-ads-for-the-new-season/',
  articleThreeHeader: 'NBA Digs Deeper Into Personal Stories, On and Off the Court, in Ads for the New Season',
  articleThreeByline: 'By: David Gianatasio',
  
  articleFourPublication: 'Shoot',
  articleFourLink: 'https://www.shootonline.com/node/73560',
  articleFourHeader: 'Translation Hires John Fulbrook as Group Creative Director, Design',
  articleFourByline: 'By: Robert Goldrich',

  articleSixPublication: 'Brandchannel',
  articleSixLink: 'http://brandchannel.com/2017/10/13/dsw-101317/',
  articleSixHeader: 'How DSW Aims to Be Music to Customers’ Feet',
  articleSixByline: 'By: Sheila Shayon',
